...
function updateChart(name){
  ...
  var tip = d3.tip()
    ...
    .offset([0, 0])
    .html(function(d) {
      return "<div style='color:#f6364d'> <font color='#f6364d'>" +d.data.filter_name +": </font>" + "<span >" + d.data.score + "</span> </font> <font color='#80ce9a'>Images </font> </font> " + d.data.avg_like + " <font color='#4895ff'> Average Likes.</font> </div>"
  ...
  d3.csv('filter/'+name+'.csv', function(error, data) {
